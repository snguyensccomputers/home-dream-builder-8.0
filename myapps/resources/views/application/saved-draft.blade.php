                ...
                <div class="col-md-12">
                                ...
                                <div class="vcenter-container">
                                    <div class="vcenter">
                                        <div class="container text-center">
                                            ...
                                            <p>
                                                If you created this application and want to make changes, login
                                                <a href='#'>here</a>.
                                            </p>
                                            <p>
                                                Submitting changes will send you another email to yourself and to
                                                a representative of Home Dream Builder.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="slider-value"><span>{{ $application->asking_price }}</span></div>
                                    <div class="slider-container">
                                        <span class="minmax-value">$80,000</span>
                                        <input type="hidden" name="asking-price" value="{{ $application->asking_price }}"/>
                                        <input type="text"
                    ...
                    <section id="monthly-payment" class='{{ (($savedDraft->left_at == "monthly-payment") ? 'active' : '') }}'>
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="slider-value"><span>{{ $application->monthly_payment }}</span></div>
                                    <div class="slider-container">
                                        <span class="minmax-value">$500</span>
                                        <input type="hidden" name="monthly-payment" value="{{ $application->monthly_payment }}"/>
                                        <input type="text"
                    ...
                    <section id="current-amount" class='{{ (($savedDraft->left_at == "current-amount") ? 'active' : '') }}'>
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="slider-value"><span>{{ $application->current_amount }}</span></div>
                                    <div class="slider-container">
                                        <span class="minmax-value">$0</span>
                                        <input type="hidden" name="current-amount" value="{{ $application->current_amount }}"/>
                                        <input type="text"
                    ...
                    <section id="dwelling-types" class='multiple-choices {{ (($savedDraft->left_at == "dwelling-types") ? 'active' : '') }}'>
                        <div class="container">
                            <input type="hidden" name="dwelling-types" value="{{ $application->dwelling_types }}" />
                            <div class="text-center ft-700">* You can select multiple dwelling types</div>
                            <h2>4. Dwelling Type</h2>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="property-img">
                                        <img src="{{ asset('/images/homedreambuilder/application/dwelling-type/single-family.jpg') }}" alt="Single Family" class="{{ (strpos($application->dwelling_types, 'Single Family') !== false) ? 'selected' : '' }}"/>
                                        <h3>Single Family</h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="property-img">
                                        <img src="{{ asset('/images/homedreambuilder/application/dwelling-type/patio.jpg') }}" alt="Patio Home" class="{{ (strpos($application->dwelling_types, 'Patio Home') !== false) ? 'selected' : '' }}"/>
                                        <h3>Patio Home</h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="property-img">
                                        <img src="{{ asset('/images/homedreambuilder/application/dwelling-type/townhome.jpg') }}" alt="Townhome" class="{{ (strpos($application->dwelling_types, 'Townhome') !== false) ? 'selected' : '' }}"/>
                                        <h3>Townhome</h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="property-img">
                                        <img src="{{ asset('/images/homedreambuilder/application/dwelling-type/condo.jpg') }}" alt="Condo" class="{{ (strpos($application->dwelling_types, 'Condo') !== false) ? 'selected' : '' }}"/>
                                        <h3>Condo</h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="property-img">
                                        <img src="{{ asset('/images/homedreambuilder/application/dwelling-type/manufactured-home.jpg') }}" alt="Manufactured" class="{{ (strpos($application->dwelling_types, 'Manufactured') !== false) ? 'selected' : '' }}"/>
                                        <h3>Manufactured</h3>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="property-img">
                                        <img src="{{ asset('/images/homedreambuilder/application/dwelling-type/twin-house.jpg') }}" alt="Twin Home (Gemini)" class="{{ (strpos($application->dwelling_types, 'Twin Home (Gemini)') !== false) ? 'selected' : '' }}"/>
                    ...
                    <section id="dwelling-styles" class='{{ (($savedDraft->left_at == "dwelling-styles") ? 'active' : '') }}'>
                        <div class="container">
                            ...
                            <input type="hidden" name="dwelling-styles" value="{{ $application->dwelling_styles }}" />
                            <h2>5. Dwelling Style</h2>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="checkbox-btns">
                                        <div class="checkbox-btn">
                                            <input type="checkbox" name="dwelling-style" value="Detached" {{ (strpos($application->dwelling_styles, 'Detached') !== false) ? 'checked="checked"' : '' }} /> <span>Detached</span>
                                        </div>
                                        <div class="checkbox-btn">
                                            <input type="checkbox" name="dwelling-style" value="Attached" {{ (strpos($application->dwelling_styles, 'Attached') !== false) ? 'checked="checked"' : '' }} /> <span>Attached</span>
                                        </div>
                                        <div class="checkbox-btn">
                                            <input type="checkbox" name="dwelling-style" value="Stacked" {{ (strpos($application->dwelling_styles, 'Stacked') !== false) ? 'checked="checked"' : '' }} /> <span>Stacked</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-sm-offset-2">
                                    <input type="text" name="city" class="form-control" value="{{ $application->city }}" placeholder="City"/>
                                </div>
                            </div>
                            <div class="row mt60">
                                <div class="col-md-12 text-center">
                    ...
                    <section id="zipcode" class='{{ (($savedDraft->left_at == "zipcode") ? 'active' : '') }}'>
                        <div class="container">
                            <div class="row">
                                <h2>7. Zip Code</h2>
                                <div class="col-sm-8 col-sm-offset-2">
                                    <input type="text" name="zipcode" class="form-control" value="{{ $application->zipcode }}" placeholder="Ex. 12345,54321,13524"/>
                                </div>
                            </div>
                            <div class="row mt60">
                                <div class="col-md-12 text-center">
                    ...
                    <section id="num-of-bedrooms" class='{{ (($savedDraft->left_at == "num-of-bedrooms") ? 'active' : '') }}'>
                        <div class="container">
                            <input type="hidden" name="num-of-bedrooms" value="{{ $application->num_of_bedrooms }}" />
                            <h2>8. # of Bedrooms</h2>
                            <div class="row">
                    ...
                    <section id="num-of-bathrooms" class='{{ (($savedDraft->left_at == "num-of-bathrooms") ? 'active' : '') }}'>
                        <div class="container">
                            <input type="hidden" name="num-of-bathrooms" value="{{ $application->num_of_bathrooms }}" />
                    ...
                    <section id="approx-sq-ft-home" class='{{ (($savedDraft->left_at == "approx-sq-ft-home") ? 'active' : '') }}'>
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="slider-value"><span>{{ $application->approx_sq_ft_home }}</span></div>
                                    <div class="slider-container">
                                        <span class="minmax-value">500</span>
                                        <input type="hidden" name="approx-sq-ft-home" value="{{ $application->approx_sq_ft_home }}"/>
                                        <input type="text"
                    ...
                    <section id="lot-size-slide" class='{{ (($savedDraft->left_at == "lot-size-slide") ? 'active' : '') }}'>
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="slider-value"><span>{{ $application->lot_size_slide }}</span></div>
                                    <div class="slider-container">
                                        <span class="minmax-value">7,000</span>
                                        <input type="hidden" name="lot-size-slide" value="{{ $application->lot_size_slide }}"/>
                                        <input type="text"
                    ...
                    <section id="num-of-interior-levels" class='{{ (($savedDraft->left_at == "num-of-interior-levels") ? 'active' : '') }}'>
                        <div class="container">
                            <input type="hidden" name="num-of-interior-levels" value="{{ $application->num_of_interior_levels }}" />
                    ...
                    <section id="year-built" class='{{ (($savedDraft->left_at == "year-built") ? 'active' : '') }}'>
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="slider-value"><span>{{ $application->year_built }}</span></div>
                                    <div class="slider-container">
                                        <span class="minmax-value">1900</span>
                                        <input type="hidden" name="year-built" value="{{ $application->year_built }}"/>
                                        <input type="text"
                    ...
                    <section id="garage-spaces" class='{{ (($savedDraft->left_at == "garage-spaces") ? 'active' : '') }}'>
                        <div class="container">
                            <input type="hidden" name="garage-spaces" value="{{ $application->garage_spaces }}" />
                    ...
                    @for ($i = 14; $i < count($homeFeaturesList); $i++)
                        @if (array_key_exists('Sub Features', $homeFeaturesList[$i]))
                            @for ($h = 0; $h < count($homeFeaturesList[$i]['Sub Features']); $h++)
                                <?php $ct++; ?>
                                {!! Application::yesNoQuestion($ct, $homeFeaturesList[$i]['Sub Features'][$h]['Section ID'], $homeFeaturesList[$i]['Sub Features'][$h]['Class'], $homeFeaturesList[$i]['Sub Features'][$h]['Title'], true, $savedDraft->left_at, $application[str_replace('-', '_', $homeFeaturesList[$i]['Sub Features'][$h]['Section ID'])]) !!}
                            @endfor
                        @else
                            <?php $ct++; ?>
                            {!! Application::yesNoQuestion($ct, $homeFeaturesList[$i]['Section ID'], $homeFeaturesList[$i]['Class'], $homeFeaturesList[$i]['Title'], true, $savedDraft->left_at, $application[str_replace('-', '_', $homeFeaturesList[$i]['Section ID'])]) !!}
                        @endif
                    @endfor
                                        ...
                                        <table class="table-bordered" id='form-table'>
                                            ...
                                            @for ($i = 0; $i < count($homeFeaturesList); $i++)
                                                @if (array_key_exists('Sub Features', $homeFeaturesList[$i]))
                                                    @for ($h = 0; $h < count($homeFeaturesList[$i]['Sub Features']); $h++)
                                                        <?php $ct++; ?>
                                                        {!! Application::formTableValue($ct, $homeFeaturesList[$i]['Sub Features'][$h]['Section ID'], $homeFeaturesList[$i]['Sub Features'][$h]['Title'], $application[str_replace('-', '_', $homeFeaturesList[$i]['Sub Features'][$h]['Section ID'])], $top10Features) !!}
                                                    @endfor
                                                @else
                                                    <?php $ct++; ?>
                                                    {!! Application::formTableValue($ct, $homeFeaturesList[$i]['Section ID'], $homeFeaturesList[$i]['Title'], $application[str_replace('-', '_', $homeFeaturesList[$i]['Section ID'])], $top10Features) !!}
                                                @endif
                                            @endfor
                                            </tbody>
                                        </table>
